...
export class ProductoService {
  ...
  createProductByHtml(
    ...
    descripcion: string,
    cantidadDisponiblesParaUso: string,
    cantidadDisponiblesParaArreglo: string,
    cantidadEnUso: string,
    cantidadEnArreglo: string,
    image: File
  ) {
    ...
    fd.append(
      'cantidadTotal',
      String(
        Number(cantidadDisponiblesParaUso) +
          Number(cantidadDisponiblesParaArreglo) +
          Number(cantidadEnUso) +
          Number(cantidadEnArreglo)
      )
    );
  ...
  moverProductoId(
    ...
    return this.httpClient
      .put<Producto>(this.URL_API + '/mover/' + idProducto, {
        desde: desde,
        hasta: hasta,
        cantidad: cantidad,
      })
  ...
  agregarUnidadProductoId(
    idProducto: string,
    agregar: String,
    cantidad: String
  ): Observable<Producto> {
    return this.httpClient
      .put<Producto>(this.URL_API + '/agregar/' + idProducto, {
        agregar: agregar,
        cantidad: cantidad,
      })
      .pipe(
  ...
  botarCantidadProductoId(
    idProducto: string,
    eliminar: String,
    cantidad: String
  ): Observable<Producto> {
    return this.httpClient
      .put<Producto>(this.URL_API + '/eliminar/' + idProducto, {
        eliminar: eliminar,
        cantidad: cantidad,
      })
      .pipe(
